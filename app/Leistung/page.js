...
import '../Leistung/page.modules.css'
  ...
  return (
    <>
      ...
      <section className='section Sthree'>
        ...
        <div>
            <p>
              Wir unterstützen Sie über den gesamten Zeitraum eines Projektes bei:
            </p>
            <br></br>
            <ul>
              <li>●  Planung</li>
          ...
          <br></br>
            <p>
              ...
              Auch pachtrechtliche Fragen müssen möglicherweise geklärt werden.
            </p>
        </div>
      </section>
</>
